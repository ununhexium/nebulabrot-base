...
/**
 * 
 * Thread to compute the {@link AbstractQuadTreeNode}s' status of the given {@link QuadTreeManager} using OpenCL
 * 
...
//    {
//        long start = System.currentTimeMillis();
//        QuadTreeManager manager = new QuadTreeManager(new AbstractQuadTreeNode(-2.0, 2.0, -2.0, 2.0), 256, 4096, 5, 4);
