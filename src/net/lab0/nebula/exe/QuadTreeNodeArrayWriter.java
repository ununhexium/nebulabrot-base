...
public class QuadTreeNodeArrayWriter extends Writer<MandelbrotQuadTreeNode[]>
{
    public QuadTreeNodeArrayWriter(CascadingJob<?, MandelbrotQuadTreeNode[]> parentJob, MandelbrotQuadTreeNode[] data, Path outputPath)
    {
