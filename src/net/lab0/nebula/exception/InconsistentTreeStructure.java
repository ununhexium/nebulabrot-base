...
/**
 * @author 116 Indicates that the tree has an unexpected structure.
 */
...
extends RuntimeException
{
    ...
    public InconsistentTreeStructure(String message, Throwable cause, boolean enableSuppression,
